...
async def on_message(message):
    if message.content.upper().startswith('!HELP'):
        ...
        await client.send_message(message.channel, "<@%s> Hallo! als eerst bedankt dat je mijn bot wil gebruiken en daarom hier een paar commands die je kan gebruiken: ``!say [iets wat je de bot wil laten zeggen]`` ``!koekje [dan stuurt de bot je een koekje :)]``" % (userID))
...
client.run(str(os.environ.get('bot_toke')))
